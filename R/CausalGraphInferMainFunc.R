...
#' \item{CausalGRes$causalInfo[['i,j']]$CDirmean}{A mean-esitamted-causal-direction degree of i cause j.}
...
#' \item{CausalGRes$causalInfo[['i,j']]$SignConfInv}{An \code{alpha}*100th percentile confidence interval of i,j odd difference from bootstraping. }
#' \item{CausalGRes$causalInfo[['i,j']]$Signmean}{A mean of i,j odd difference from bootstraping.}
#'
#' @examples
